...
We create an indicator that takes the value of **1** if the woman declares that she did have a mammography in 2011 (the year previous to the survey) and is equal to **0** if not. 
...
We create a second indicator that takes the value of **1** if the woman responded that she had a mammography exactly one year before the survey question was posed (in 2011) and is equal to **0** if not. 
...
We create three categorical variables to divide the **age** variable into different categories:
