...
First we load all necessary libraries and define the auxiliary functions that are described in the *Auxiliary Functions* markdown file. 
...
setwd('/Users/Ernesto/Documents/INCAN/Reproducibility-cost-effectiveness/')
source('Auxiliary Functions/auxiliary-functions.R')
